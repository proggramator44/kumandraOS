...
def note():
    ...
    def openfile():
        global e1
        path = filedialog.askopenfilename(initialdir='tracks/', title="Выберите файл!")
...
def actuve():
    ...
    c = Canvas(act, width=800, height=800)
    a1 = PhotoImage(file='active+.gif')
    a = Label(act, image=a1)
    a.pack()
